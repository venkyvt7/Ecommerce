...
var tt={userid:userid,productsid:productid.toString()}
...
try
{   var ordersbyid=await Orders.findAll({where:{userid}});
...
// console.log(productids[j])
    const ordersbyid1=await Products.findOne({where:{id:productids[j]}});
